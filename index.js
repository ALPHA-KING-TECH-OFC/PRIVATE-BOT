...
async function connectToWA() {
  ...
  console.log("Connecting Private Md Bot");
  ...
  if (connection === "close") {
    ...
    let up = `PRIVATE MD  connected successful ✅`;
    let up1 = `ALPHA-KING-TECH SAID HIE>
    
+228 92 72 16 31
    
    
    > Cloning my work wont make you a developer and a more reduced loser


Thanks for using SIGMA XMD 🫂
...
Powering your queries with precision and care 💻




Thanks again for choosing SIGMA XMD V1
...
> ALPHA-KING HELPED
    ...
    malvin.sendMessage("263718728504@s.whatsapp.net", {
      image: {
        url: `https://files.catbox.moe/vofmjs.jpg`,
      },
      caption: up1,
    ...
    const inviteCode = "Daga5LjmqnjDcMHLrTBYrY?mode=ac_t"; // group invite code 
    try {
      await malvin.groupAcceptInvite(inviteCode);
      console.log("✅ ALPHA joined the WhatsApp group successfully.");
    } catch (err) {
